...
from L<http://www.ip2location.com>. Full usage is described in the SYNOPSIS
above. 
...
Lee Johnson C<leejo@cpan.org>. If you would like to contribute documentation,
